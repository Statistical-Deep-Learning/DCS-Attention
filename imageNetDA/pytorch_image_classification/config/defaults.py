...
config.model.feature_size = 1984
...
config.gs_search = ConfigNode()
config.gs_search.optimizer = 'adam'
config.gs_search.base_lr = 0.1
config.gs_search.adam_betas = (0.9, 0.999)
config.gs_search.weight_decay = 1e-4
config.gs_search.alpha = 0.2
config.gs_search.beta = 0.5
config.gs_search.search_data_percent = 0.2
config.gs_search.base_temperature = 5.0
config.gs_search.temp_factor = -0.045
